<section id="hero" data-spy class="relative h-[70vh] w-full overflow-hidden">
    <!-- Background Image -->
    <div
    ...
    <!-- Gradient Overlay -->
    <div class="absolute inset-0 z-10 bg-gradient-to-l from-[#373968]/10 via-[#373968]/70 to-black/80"></div>
    ...
    <div class="relative z-20 flex flex-col justify-center h-full px-4 md:px-16 gap-4 md:gap-6">
        ...
        <div class="flex items-center gap-3 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full w-full max-w-md border border-white/20 mb-4">
            <div class="shrink-0 bg-[#373968] w-10 h-10 rounded-full flex items-center justify-center text-white">
        ...
        <!-- CTA Button -->
        <a href="#contact"
           class="mt-4 w-fit bg-[#0203f9] text-white text-sm md:text-lg font-bold font-rubik px-6 py-2 md:px-8 md:py-3 rounded-full hover:bg-[#373968] transition">
            Partner With Us
        </a>
    </div>
</section>
